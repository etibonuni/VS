...
def doMolGMM(molNdx):
    ...
    for portion in datasetPortion:
        ...
        [r[0].iloc[0:1, :] for r in folds_list[i]]
        ...
        auc_sim = eval.plotSimROC(results["truth"], [results["score"]],
                              molName+"[ANN_LEC, "+str(portion*100)+"%]",
                              "results/"+molName+"_ANN_LEC_sim_"+str(portion*100)+".pdf")
        auc_rank = eval.plotRankROC(results["truth"], [results["score"]],
                                    molName + "[ANN_LEC-" + str(portion * 100) + "%]",
                                    "results/" + molName + "_ANN_LEC_rank_" + str(portion*100) + ".pdf")
        ...
        f1 = open("results/results_ann_lec_"+molName+".txt", 'w')
